        ...
        <div class="uk-container">
            ...
            <div uk-grid class="uk-grid-match">
                ...
                <div class="uk-width-1-3@l uk-width-1-3@m uk-width-1-1">
                    <div class="page-nav">
                        <ul class="uk-list">
                            <li><a href="#">კალკულუსი</a></li>
                            <li><a href="#">ვექტორული კალკულუსი</a></li>
                            <li><a href="#">დიფერენციალური განტოლებები</a></li>
                            <li><a href="#">ქაოსის თეორია</a></li>
                            <li><a href="#">კომპლექსური ანალიზი</a></li>
                        </ul>
                    </div>
                </div>
            </div>
