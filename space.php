        ...
        <div class="uk-container">
            ...
            <div uk-grid class="uk-grid-match">
                ...
                <div class="uk-width-1-3@l uk-width-1-3@m uk-width-1-1">
                    <div class="page-nav">
                        <ul class="uk-list">
                            <li><a href="#">გეომეტრია</a></li>
                            <li><a href="#">ტრიგონომეტრია</a></li>
                            <li><a href="#">დიფერენციალური გეომეტრია</a></li>
                            <li><a href="#">ტოპოლოგია</a></li>
                            <li><a href="#">ფრაქტალური გეომეტრია</a></li>
                        </ul>
                    </div>
                </div>
            </div>
